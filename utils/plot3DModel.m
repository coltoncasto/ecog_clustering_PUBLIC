function [surf] = plot3DModel(ax,model,annotation,alpha,varargin)
...
if isempty(annotation)
    annotation=ones(size(model.vert,1),1)*175;
end

surf=trisurf(model.tri, model.vert(:, 1), model.vert(:, 2), model.vert(:, 3),annotation ,'FaceAlpha',alpha,'Parent',...
